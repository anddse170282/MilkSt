...
const HomePage = () => {
    ...
    const [preferentialProducts, setPreferentialProducts] = useState([]);
    ...
    useEffect(() => {
      const fetchProducts = async () => {
        try {
          ...
          const responseNewProducts = await axios.get('https://localhost:7188/api/milks');
          setNewProducts(responseNewProducts.data);
  
          // Thay thế 'API_URL_PREFERENTIAL_PRODUCTS' bằng URL API để lấy dữ liệu sản phẩm ưu đãi
          const responsePreferentialProducts = await axios.get('https://localhost:7188/api/milks');
          setPreferentialProducts(responsePreferentialProducts.data);
  
          // Thay thế 'API_URL_OTHER_PRODUCTS' bằng URL API để lấy dữ liệu các sản phẩm khác
          const responseOtherProducts = await axios.get('https://localhost:7188/api/milks');
          setOtherProducts(responseOtherProducts.data);
        } catch (error) {
