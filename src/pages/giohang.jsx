      ...
      <div className="cart-container">
        <header className="header">
          <div className="logo-container">
            <a href="HomePage.html"><img src="https://firebasestorage.googleapis.com/v0/b/imageuploadv3.appspot.com/o/Logo%20Footer%2Fdep2.png?alt=media&token=08b080e1-c883-4c89-ba4f-76f8f0a57b00" width="150" height="150" alt="Logo" />
            </a>
          </div>
